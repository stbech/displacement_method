...
file = '_input_LC_1'
file_main = '_input_LC_1.gpd'#file . '.gpd'
...
print file_main
plot    #file_main i 0 w l lc rgb 'black' notitle, \
        #file_add  i 0 w l lc rgb 'black' dt 2 notitle, \
        #file_add  i 1 u ($1+factor_s*$3):($2+factor_s*$4) w l lc rgb 'black' notitle,\
        file_main i 1 u (x_plot($1, $3, $4, $5, factor)):(y_plot($2, $3, $4, $5, factor)) ev:4::s w l notitle lc rgb 'red', \
